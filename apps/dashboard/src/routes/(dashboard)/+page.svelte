...
<div class="space-y-8">
	...
	{#if !user.isPremium}
		<div class="relative overflow-hidden rounded-2xl border border-violet-500/20 bg-linear-to-r from-violet-500/10 via-fuchsia-500/10 to-violet-500/10 p-5 mb-0">
			...
			<div class="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
				<div class="flex items-center gap-4">
					<div class="w-10 h-10 rounded-xl bg-linear-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center shrink-0">
				...
				<div class="flex items-center gap-3 shrink-0">
					<a href="/premium" class="px-5 py-2.5 rounded-xl bg-linear-to-r from-violet-600 to-fuchsia-600 text-white text-sm font-semibold shadow-lg shadow-violet-900/20 hover:shadow-violet-900/40 hover:-translate-y-0.5 transition-all whitespace-nowrap">
						Passer à Premium →
					</a>
				</div>
			</div>
	...
	<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-linear-to-r from-slate-900 to-slate-800 p-8 rounded-3xl border border-slate-800 relative overflow-hidden">
		...
		<div class="relative z-10">
			<h1 class="text-3xl md:text-4xl font-bold text-white mb-2">Bonjour, <span class="text-transparent bg-clip-text bg-linear-to-r from-violet-400 to-fuchsia-400">{user?.userName || 'Créateur'}</span> 👋</h1>
						...
						<tbody class="divide-y divide-slate-800 text-sm">
							{#each links as link}
								<tr class="hover:bg-slate-800/30 transition-colors">
									...
									<td class="px-6 py-4 text-slate-400 truncate max-w-50">{link.url}</td>
		...
		<div>
			<div class="sticky top-8">
				<div class="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-6 shadow-2xl shadow-black/50 relative overflow-hidden">
					<div class="absolute top-0 left-0 w-full h-32 bg-linear-to-b from-violet-900/20 to-transparent pointer-events-none"></div>

					<div class="flex items-center justify-between mb-6 relative z-10">
						<h3 class="text-base font-semibold text-white">Aperçu mobile</h3>
						<a href="/p/{plinkk?.slug || user?.id}" target="_blank" class="p-2 bg-slate-800 hover:bg-slate-700 rounded-full text-slate-300 transition-colors" aria-label="Aller sur la page" aria-labelledby="h3">
					...
					<div class="relative mx-auto border-slate-950 bg-slate-950 border-10 rounded-[3rem] h-150 w-75 shadow-xl ring-1 ring-slate-800">
